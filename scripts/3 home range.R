...
# Script description: calculate home range estimate using akde, extract home range estimates, create a pairwise overlap dataframe from their home range estimates for each individual, calculate their overlap values, home range and home range overlap analysis
