...
saveRDS(DATA_GPS, file = "RDS/DATA_GPS.RDS")
saveRDS(DATA_TELEMETRY, file = "RDS/DATA_TELEMETRY.RDS")
saveRDS(DATA_META, file = "RDS/DATA_META.RDS")
saveRDS(DATA_BIO, file = "RDS/DATA_BIO.RDS")