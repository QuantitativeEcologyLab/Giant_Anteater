...
```{r}
FIT.1 <- readRDS("C:/Users/achhen/OneDrive - UBC/BIOL 452 Directed Studies - Giant Anteaters/Github/giantanteater/R working directory (giant anteater)/FIT.1.RDS")
overlap(FIT.1)
```
...
```{r}
FIT.1.male <- readRDS("C:/Users/achhen/OneDrive - UBC/BIOL 452 Directed Studies - Giant Anteaters/Github/giantanteater/R working directory (giant anteater)/FIT.1.male.RDS")
overlap(FIT.1.male)
```
...
#### Load saved fitted model
```{r}
FIT.1.male.adult <- readRDS("C:/Users/achhen/OneDrive - UBC/BIOL 452 Directed Studies - Giant Anteaters/Github/giantanteater/R working directory (giant anteater)/FIT.1.male.adult.RDS")
...
#### Load saved fitted model
```{r}
FIT.1.female <- readRDS("C:/Users/achhen/OneDrive - UBC/BIOL 452 Directed Studies - Giant Anteaters/Github/giantanteater/R working directory (giant anteater)/FIT.1.female.RDS")
...
#### Load saved fitted model
```{r}
FIT.2 <- readRDS("C:/Users/achhen/OneDrive - UBC/BIOL 452 Directed Studies - Giant Anteaters/Github/giantanteater/R working directory (giant anteater)/FIT.2.RDS")
overlap(FIT.2)
```
...
#### Load saved fitted model
```{r}
FIT.2.male <- readRDS("C:/Users/achhen/OneDrive - UBC/BIOL 452 Directed Studies - Giant Anteaters/Github/giantanteater/R working directory (giant anteater)/FIT.2.male.RDS")
overlap(FIT.2.male)
```
...
#### Load saved fitted model
```{r}
FIT.2.male.adult <- readRDS("C:/Users/achhen/OneDrive - UBC/BIOL 452 Directed Studies - Giant Anteaters/Github/giantanteater/R working directory (giant anteater)/FIT.2.male.adult.RDS")
...
#### Load saved fitted model
```{r}
FIT.2.female <- readRDS("C:/Users/achhen/OneDrive - UBC/BIOL 452 Directed Studies - Giant Anteaters/Github/giantanteater/R working directory (giant anteater)/FIT.2.female.RDS")
...
```{r}
AKDE.1 <- readRDS("C:/Users/achhen/OneDrive - UBC/BIOL 452 Directed Studies - Giant Anteaters/Github/giantanteater/R working directory (giant anteater)/AKDE.1.RDS")
overlap(AKDE.1)
```
...
#### Load saved AKDE aligned UDs
```{r}
AKDE.1.male <- readRDS("C:/Users/achhen/OneDrive - UBC/BIOL 452 Directed Studies - Giant Anteaters/Github/giantanteater/R working directory (giant anteater)/AKDE.1.male.RDS")
overlap(AKDE.1.male)
```
...
#### Load saved AKDE aligned UDs
```{r}
AKDE.1.male.adult <- readRDS("C:/Users/achhen/OneDrive - UBC/BIOL 452 Directed Studies - Giant Anteaters/Github/giantanteater/R working directory (giant anteater)/AKDE.1.male.adult.RDS")
...
Using tryCatch
```{r}
for(i in 1:nrow(DATA.pairwise)){
  ANIMAL_A <- as.character(DATA.pairwise[i, 'anteater_A']) # add as.character due to tibble format
  ANIMAL_B <- as.character(DATA.pairwise[i, 'anteater_B'])
  TRACKING_DATA <- DATA[c(ANIMAL_A, ANIMAL_B)] # extract anteater by name, has extra layers .-. it doesnt work, that is why
    # line above is using as.character removes all the fluff because you just want the text string
  MODELS <- list(FIT.1[ANIMAL_A][[1]], FIT.1[ANIMAL_B][[1]])
  PROXIMITY <- tryCatch(
    {
  ...
  DATA.pairwise[i, c("proximity_low")] <- PROXIMITY[1]
  DATA.pairwise[i, c("proximity_est")] <- PROXIMITY[2]
  DATA.pairwise[i, c("proximity_high")] <- PROXIMITY[3]
  write.csv(DATA.pairwise.1, "C:/Users/achhen/OneDrive - UBC/BIOL 452 Directed Studies - Giant Anteaters/Github/giantanteater/giant anteater data/DATA.proximity.1.csv", row.names = FALSE)
}
```
