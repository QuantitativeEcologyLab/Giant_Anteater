...
#load distance data
distance_df <- readRDS("data/distance_df.rds")
#load encounter data
...
distance_pairs_df <- readRDS("data/distance_pairs_df.RDS")
...
#save telemetry data
saveRDS(DATA_TELEMETRY, file = "data/DATA_TELEMETRY.rds")
```
...
round(mean(dat.hr$HR_est), 2)

#calculate CIs of the mean total home-range size
round(mean(dat.hr$HR_low), 2)
round(mean(dat.hr$HR_high), 2)
```
