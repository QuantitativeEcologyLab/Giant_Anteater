...
#saveRDS(overlap_data, file = "data/home_range/overlap_data_adults.rds")
```
...
DATA_DISTANCE <- readRDS("data/proximity/DATA_DISTANCE.rds")
...
distance_data <- merge(DATA_DISTANCE, proximity_data, by = "pair_ID")
...
#saveRDS(distance_data, file = "data/proximity/distance_data_adults.rds")
```
...
proximity_below1 <- proximity_below1[proximity_below1$overlap_est > 0.001,]
...
#saveRDS(proximity_identified_pairs_df, file = "data/proximity/proximity_identified_adult_pairs_df.rds")
```
